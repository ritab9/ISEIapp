...
class SchoolYear(admin.ModelAdmin):
    list_display = ('name','current_school_year','active_year', 'start_date', 'end_date','sequence')
    list_editable = ('current_school_year','active_year','start_date', 'end_date', 'sequence')
