...
def email_registered_user(teacher):
    ...
    message = "Dear "+  str(teacher.first_name) + ", " + "\n" + "\n" + \
               "Welcome! " + "\n" + \
               "An account has been created for you on the ISEI platform. (ISEI is an Education Association that your school -" +str(teacher.user.profile.school.name) +" -is member of / accredited by.)" + \
